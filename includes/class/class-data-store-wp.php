 ...
 * Original file: https://github.com/woocommerce/woocommerce/blob/master/includes/data-stores/class-wc-data-store-wp.php
 *
 * @package AnsPress
 * @subpackage Classes
 * @since 4.2.0
...
class Data_Store_WP {
	...
	public function read_meta( &$object ) {
		...
		return apply_filters( "ap_data_store_wp_{$this->meta_type}_read_meta", $meta_data, $object, $this );
	}
	...
	protected function get_wp_query_args( $query_vars ) {
		...
		return apply_filters( 'ap_get_wp_query_args', $wp_query_args, $query_vars );
	}

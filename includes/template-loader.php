 ...
 *
 * @since 4.2.0 Renamed to `template-loader.php` from `class-theme.php`.
 */
 ...
 * @since  4.2.0
 */
function redirect_answer( $template = '' ) {
 ...
 * @since 4.2.0
 */
function template_include_theme_compat( $template = '' ) {
 ...
 */
function question_answer_post_class( $classes ) {
	global $post;
 ...
 * @since 4.1.0
 */
function remove_hentry_class( $post_classes, $class, $post_id ) {
	$_post = ap_get_post( $post_id );
 ...
 */
function after_question_content() {
...
/**
 * Get the templates to use as the endpoint for anspress template parts.
 *
...
/**
 * Intercept the template being loaded when needed.
 *
 * @param string $template
 * @return string The path to the template file that is being used.
 * @since 4.2.0
 */
function template_include_theme_supports( $template = '' ) {
	if ( ap_is_archive() ) {

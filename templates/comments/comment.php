...
$classes   = [ 'ap-comment' ];
$classes[] = '1' != $comment->comment_approved ? 'unapproved' : 'approved';
?>
<apcomment id="comment-<?php echo $comment->comment_ID; ?>" <?php comment_class( $classes ); ?>>
	<div itemprop="comment" itemscope itemtype="http://schema.org/Comment">
		<div class="ap-avatar"><?php echo get_avatar( $comment->user_id, $avatar_size ); ?></div>
		<div class="comment-inner">

			<div class="ap-comment-header">
				<a href="<?php echo esc_url( ap_user_link( $comment->user_id ) ); ?>" class="ap-comment-author" itemprop="creator" itemscope itemtype="http://schema.org/Person"><span itemprop="name"><?php echo ap_user_display_name( $comment ); ?></span></a> <?php _e( 'commented', 'anspress-question-answer' ); ?>
